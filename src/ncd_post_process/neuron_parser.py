...
def parse_neuron(parser, neuron_id, output_dir):
    full_path = "/data/neural_collision_detection/results/fig1/{neuron_id}".format(**locals())
    ...
    np.savez(f'/data/neural_collision_detection/results/for_article/fig1/collisions_nparser_{thresh}.npz', translated=all_collisions)
