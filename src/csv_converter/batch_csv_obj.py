...
def find_csv(foldername):
    ...
    all_faces = foldername.rglob('faces*.csv')
    all_vertices = foldername.rglob('vertices*.csv')
...
if __name__ == '__main__':
    find_csv(pathlib.Path('/data/simulated_morph_data/neural_collision_detection/convert_obj_matlab'))
