...
* Discussion items for next meeting:
  ...
  correctly? Should we show the neuron on pipes toy example?
  2. How should the figure showing the distribution of collisions over time
  look like?
  3.

* The ``for_article`` folder contains the needed figures for figure 1.
  I also wrote two scripts to process the data that was generated by Yoav
  for these figures.
