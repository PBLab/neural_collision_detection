...
set_target_properties(ccd PROPERTIES
  IMPORTED_LINK_INTERFACE_LIBRARIES_RELEASE "/usr/lib64/libm.so"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib64/libccd.so.2.0"
  IMPORTED_SONAME_RELEASE "libccd.so.2"
  )

list(APPEND _IMPORT_CHECK_TARGETS ccd )
list(APPEND _IMPORT_CHECK_FILES_FOR_ccd "${_IMPORT_PREFIX}/lib64/libccd.so.2.0" )
